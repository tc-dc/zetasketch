...
public final class HyperLogLogPlusPlus<V> implements Aggregator<V, Long, HyperLogLogPlusPlus<V>> {
  ...
  public static class Builder {
    ...
    /** Returns a new HLL++ aggregator.
     *
     * @param valueType the {@code ValueType} of the HLL++, it cannot collide with the standard {@code ValueTypes}. It is recommeded
     *                  to use value types with a numeric value greater than 1000.
     * @param hash The custom {@code Hash} function which is to be used.
     */
